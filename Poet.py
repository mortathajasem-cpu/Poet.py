...
# ---------------------------------------------------------
# التوكين الجديد (بوت الشعراء)
TOKEN = "8415619653:AAE2Jz4I5WHMS0ORGS1eG63MGvAj53UgISY"
# ---------------------------------------------------------
...
# قائمة الأسئلة (نفس الأسئلة الشخصية لتحليل النفسية الشعرية)
questions = [
...
def show_result(chat_id):
    ...
    # --------------------------------------------------------
    # تصنيفات الشعراء الخمسة (بناءً على النقاط)
    # --------------------------------------------------------
